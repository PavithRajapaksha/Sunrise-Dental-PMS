...
class PatientServiceTest {
    ...
    void Register_withValidData_shouldReturnPatient() throws ValidationException {
        when(patientDao.createPatient("Kasun Silva", "12 Galle Road, Colombo", "0711234567")).thenReturn(samplePatient);

        Patient result = patientService.registerPatient("Kasun Silva", "12 Galle Road, Colombo", "0711234567");
    ...
    void Register_whenDaoReturnsNull_shouldFail() {
        when(patientDao.createPatient("Kasun Silva", "12 Galle Road, Colombo", "0711234567")).thenReturn(null);

        assertThrows(ValidationException.class,
                () -> patientService.registerPatient("Kasun Silva", "12 Galle Road, Colombo", "0711234567"));
    }

    @Test
    void Register_whenDaoThrowsInvalidData_shouldFail() {
        when(patientDao.createPatient("", "12 Galle Road, Colombo", "0711234567"))
                .thenThrow(new IllegalArgumentException("Name cannot be empty"));

        assertThrows(ValidationException.class,
                () -> patientService.registerPatient("", "12 Galle Road, Colombo", "0711234567"));
    }
