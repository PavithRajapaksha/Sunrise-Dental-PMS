...
class AppointmentServiceTest {
    ...
    @Test
    void Book_withValidData_shouldReturnAppointment()
        ...
        when(appointmentDao.createAppointment(
                samplePatient,
                sampleDentist,
                sampleTreatmentType,
                futureDateTime,
    ...
    @Test
    void Find_withValidNumber_shouldReturnAppointment()
