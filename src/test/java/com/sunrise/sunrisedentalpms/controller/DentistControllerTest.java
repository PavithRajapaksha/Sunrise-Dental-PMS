...
class DentistControllerTest {
    ...
    @Test
    void Get_withNoId_shouldListAllDentists()
            throws Exception {
        ...
        when(request.getParameter("availableOnly"))
                .thenReturn(null);

        when(dentistService.listAllDentists())
                .thenReturn(dentists);
    ...
    @Test
    void Get_withAvailableOnly_shouldListAvailableDentists()
            throws Exception {
        ...
        when(dentistService.listAvailableDentists())
                .thenReturn(dentists);
    ...
    @Test
    void Get_withInvalidId_shouldShowErrorOnList()
            throws Exception {
    ...
    @Test
    void Post_register_withValidData_shouldRegisterDentist()
            throws Exception {
        ...
        when(request.getParameter("email"))
                .thenReturn("dr.perera@example.com");

        when(dentistService.registerDentist(
                "Dr. Perera",
                "0711234567",
                "dr.perera@example.com",
                UserRole.ADMIN
        )).thenReturn(created);
    ...
    @Test
    void Post_register_withNonAdmin_shouldShowError()
            throws Exception {
        ...
        when(dentistService.registerDentist(
                ...
                new AuthorizationException(
                        "Only an admin can register a new dentist."
                )
        );
    ...
    @Test
    void Post_updateStatus_withValidData_shouldUpdateStatus()
            throws Exception {
        ...
        verify(dentistService)
                .updateDentistStatus(
                        "1",
                        DentistStatus.UNAVAILABLE
                );

        verify(response)
                .sendRedirect(
                        "/sunrisedentalpms/dentist"
                );
    }

    @Test
    void Post_updateStatus_withInvalidStatus_shouldShowError()
            throws Exception {
